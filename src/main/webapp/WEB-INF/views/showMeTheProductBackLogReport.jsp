    ...
    <body>
        <jsp:include page="/WEB-INF/views/generalNavigation.jsp"></jsp:include>
            <div class="container col-lg-7 text-center py-5"> 
                <h3 class="title" > - PRODUCT BACKLOG REPORT - </h3>
                <div class="col-lg md-8 align-items-center">
                    ...
                    <table class="table py-5 ">
                        ...
                        <tbody>
                        <c:forEach items="${showMeTheProductBackLog}" var="task" varStatus="status" begin="0"
                                   end="${fn:length(showMeTheProductBackLog)}" step="1">
                            <tr>
                                <th scope="row">${status.count}.</th>
                                <td>${task.description}</td>
                                <td>${task.taskStartDate}</td>
                                <td>${task.taskEndDate}</td>
                                <td>${task.statusId.statusState}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
